  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#9f2d00] to-[#2c1810] text-white p-10 rounded-lg text-center mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <span className="bg-[#9f2d00] text-white px-6 py-2 rounded-full font-bold">NCMEC Compliant</span>
          <span className="bg-[#9f2d00] text-white px-6 py-2 rounded-full font-bold">COPPA Compliant</span>
          <span className="bg-[#9f2d00] text-white px-6 py-2 rounded-full font-bold">GDPR Compliant</span>
          <span className="bg-[#9f2d00] text-white px-6 py-2 rounded-full font-bold">Age Verified</span>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
          {/* Section 1: Our Commitment to Safety */}
          <section className="mb-10">
            <h2 className="text-3xl text-[#9f2d00] font-bold mb-6 border-b-4 border-[#9f2d00] pb-2">
            ...
            <div className="bg-red-50 border-l-4 border-[#9f2d00] p-6 rounded mb-6">
              <h4 className="text-xl font-bold text-[#9f2d00] mb-3">🔒 Zero Tolerance Policy</h4>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">2.1 Age Verification Process</h3>
            ...
            <div className="bg-red-50 border-l-4 border-[#ff3d57] p-6 rounded mb-6">
              <h4 className="text-xl font-bold text-[#ff3d57] mb-3">⚠️ Age Verification Requirements</h4>
              <p className="text-[#2c1810]">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">2.2 Age Verification Methods</h3>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">3.1 Automated Content Scanning</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">3.2 Human Moderation</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <div className="bg-yellow-50 border-l-4 border-[#ff3d57] p-6 rounded mb-6">
              <h4 className="text-xl font-bold text-[#ff3d57] mb-3">🚨 Prohibited Content</h4>
              <p className="text-[#2c1810] mb-3">The following content is strictly prohibited and will result in immediate account termination:</p>
              <ul className="list-disc pl-6 text-[#2c1810] space-y-1">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">4.1 How to Report</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">4.2 Response Timeline</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">4.3 Law Enforcement Cooperation</h3>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">5.1 Secure Data Handling</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">5.2 Privacy Protection</h3>
            <ul className="list-disc pl-8 space-y-2">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">6.1 Safety Guidelines</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">6.2 Educational Resources</h3>
            <ul className="list-disc pl-8 space-y-2">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">7.1 Regulatory Compliance</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">7.2 Industry Standards</h3>
            <ul className="list-disc pl-8 space-y-2">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">8.1 Regular Updates</h3>
            <ul className="list-disc pl-8 mb-6 space-y-2">
            ...
            <h3 className="text-2xl text-[#2c1810] font-bold mb-4">8.2 User Feedback</h3>
            <ul className="list-disc pl-8 space-y-2">
        ...
        <div className="bg-gray-100 p-8 rounded-lg text-center mb-8">
          <h3 className="text-2xl text-[#9f2d00] font-bold mb-6">🆘 Emergency Safety Contact</h3>
        ...
        <div className="text-center text-gray-600 border-t pt-6">
          ...
          <p>© 2025 Punjabi Rishtey. All rights reserved. | 
            <a href="/privacy-policy" className="text-[#9f2d00] hover:underline ml-1">Privacy Policy</a> | 
            <a href="/terms" className="text-[#9f2d00] hover:underline ml-1">Terms of Service</a>
          </p>
        </div>
      </div>
    </div>
